 ...
 * Date: 12/11/2018
 * Description:  Will allow the user to input their full name and then create a user id of their first initial and surname
  */
...
public class EmployeeInfo {
    ...
    private void setName() {
        ...
        if (checkName(testName)) {
            this.name = testName;
            System.out.println("Valid name, creating employee code");
