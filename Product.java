/**
 * Author: Anthony Horvath Date: 12/11/2018 Description: Class for multiple aspects and atributes of
 * the product
 */
...
public class Product implements Item, Comparable<Item> {
  ...
  /**
   * Constructor that takes in the name of the product and sets it to the variable name, assigns the
   * variable serialNumber to another variable. It increments currentProductionNumber and sets the
   * current date and time to a variable.
   */
   ...
   *
   * <p>Returns a print of the manufacturer, serial number, date, and name of the item.
   */
